...
public class UserNameRecognizer {
	...
	public static String checkForValidUserName(String input) {
		...
		case 0:
			...
			userNameRecognizerErrorMessage += "A UserName must start with A-Z, and a-z. No digits allowed.\n";
		...
		case 2:
			...
			userNameRecognizerErrorMessage +=
				"A UserName character after a period/minus signs/underscore must be A-Z, a-z, 0-9.\n";
			return userNameRecognizerErrorMessage;
